...
CUDA_VISIBLE_DEVICES='0,1,2,3' python3 -u train.py --network r100 --loss arc_circle_loss --lr 0.0002 --dataset fairface --per-batch-size 400 --pretrained /home/ubuntu/shengyao/pretrained_models/final_fix_dark_female/model --pretrained-epoch 1 --verbose 2 --selected-attributes 3 --lr-steps '6000,12000,18000' 
