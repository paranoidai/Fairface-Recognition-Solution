...
CUDA_VISIBLE_DEVICES='0,1,2,3' python3 -u train.py --network r100 --loss arc_circle_loss --lr 0.002 --dataset fairface --per-batch-size 400 --pretrained /home/ubuntu/shengyao/r100/models --verbose 125 --lr-steps '6000,12000,18000' --freeze-block 1 
